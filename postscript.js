...
// node_modules/.pnpm/flexsearch@0.7.21/node_modules/flexsearch/dist/flexsearch.bundle.js
var require_flexsearch_bundle = __commonJS({
  "node_modules/.pnpm/flexsearch@0.7.21/node_modules/flexsearch/dist/flexsearch.bundle.js"(exports, module) {
    (function _f(self) {
      "use strict";
      try {
        if (module)
...
(function () {// node_modules/.pnpm/d3-dispatch@3.0.1/node_modules/d3-dispatch/src/dispatch.js
var noop = { value: () => {
} };
function dispatch() {
...
(function () {// node_modules/.pnpm/@floating-ui+utils@0.1.6/node_modules/@floating-ui/utils/dist/floating-ui.utils.mjs
var min = Math.min;
var max = Math.max;
...
(function () {// node_modules/.pnpm/plausible-tracker@0.3.8/node_modules/plausible-tracker/build/module/lib/request.js
...
(function () {// node_modules/.pnpm/micromorph@0.4.5/node_modules/micromorph/dist/index.js
...
async function mouseEnterHandler({ clientX, clientY }) {
  const link = this;
  async function setPosition(popoverElement2) {
    const { x: x2, y } = await computePosition2(link, popoverElement2, {
      middleware: [inline({ x: clientX, y: clientY }), shift(), flip()]
    });
    Object.assign(popoverElement2.style, {
      left: `${x2}px`,
...
var isElement2 = (target) => target?.nodeType === NODE_TYPE_ELEMENT;
var isLocalUrl = (href) => {
  try {
